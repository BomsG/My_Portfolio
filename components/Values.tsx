    ...
    <section className="py-24 px-6 bg-[#FDFCFB] dark:bg-obsidian-950 transition-colors duration-500">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="text-[#6D6D6D] dark:text-slate-400">
            Technical skill combined with professional excellence.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {VALUES.map((value, index) => (
            ...
            >
              <div className="flex-shrink-0 p-3 h-fit rounded-2xl bg-cyan-50 dark:bg-blue-900/30">
                <div className="text-cyan-600 dark:text-cyan-400">
                  {value.icon}
                </div>
              </div>
              <div>
                <h3 className="text-lg font-bold mb-2 text-[#4A4A4A] dark:text-white">
                  {value.title}
                </h3>
                <p className="text-[#6D6D6D] dark:text-slate-400 leading-relaxed">
                  {value.description}
                </p>
              </div>
            </motion.div>
