  ...
  >
    ...
    <div className="p-8 flex flex-col flex-grow">
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        {project.tech.map(t => (
          <span key={t} className="px-3 py-1 bg-editorial-base/50 dark:bg-obsidian-800/50 rounded-lg text-[9px] font-bold text-editorial-slate dark:text-slate-300 border border-editorial-pebble/50 dark:border-obsidian-700/50 uppercase tracking-tighter">
            {t}
          </span>
        ))}
      </div>
...
const Projects: React.FC = () => {
  ...
  return (
    <section id="projects" className="py-32 px-6 bg-editorial-base dark:bg-obsidian-900 transition-colors duration-500 overflow-hidden">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-editorial-ink dark:text-white">Selected Works</h2>
          <p className="text-editorial-slate dark:text-slate-400 font-light max-w-2xl mx-auto text-lg">
            Focused on building high-performance applications with a strong emphasis on architecture and UX.
          </p>
        </motion.div>
          ...
          <div className="relative p-1.5 bg-white dark:bg-obsidian-800 rounded-2xl border border-editorial-pebble dark:border-obsidian-700 flex shadow-inner">
            ...
            <button
              ...
              className={`relative z-10 w-[120px] py-2.5 text-[11px] font-bold uppercase tracking-[0.2em] transition-colors duration-300 ${
                activeTab === 'web' ? 'text-white' : 'text-editorial-slate dark:text-slate-500'
              }`}
            >
            ...
            <button
              ...
              className={`relative z-10 w-[140px] py-2.5 text-[11px] font-bold uppercase tracking-[0.2em] transition-colors duration-300 ${
                activeTab === 'mobile' ? 'text-white' : 'text-editorial-slate dark:text-slate-500'
              }`}
            >
              <div className="flex items-center justify-center gap-2">
        ...
        <div className="mt-20 flex justify-center items-center gap-4">
          <div className={`w-2 h-2 rounded-full transition-all duration-500 ${activeTab === 'web' ? 'w-8 bg-editorial-ink dark:bg-cyan-500' : 'bg-editorial-pebble dark:bg-obsidian-700'}`} />
          <div className={`w-2 h-2 rounded-full transition-all duration-500 ${activeTab === 'mobile' ? 'w-8 bg-editorial-ink dark:bg-cyan-500' : 'bg-editorial-pebble dark:bg-obsidian-700'}`} />
        </div>
      </div>
    </section>
  );
